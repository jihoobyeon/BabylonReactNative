    ...
    void DeviceImpl::EnableRendering()
    {
        ...
        if (!m_state.Bgfx.Initialized)
        {
            ...
            id<MTLDevice> dev = MTLCreateSystemDefaultDevice();
						...
						m_state.Bgfx.InitState.platformData.context = dev;
						m_state.Bgfx.InitState.platformData.nwh = mv;
						m_state.Bgfx.InitState.resolution.width = cv.bounds.size.width;
						m_state.Bgfx.InitState.resolution.height = cv.bounds.size.height;
